...
BOOST_FIXTURE_TEST_SUITE(Picture_draft, Picture_draft_)
	...
	{
		unique_ptr<CShape> shape1 = make_unique<CMockShape>(Color::Black);
		CShape & refShape1 = *shape1;
		unique_ptr<CShape> shape2 = make_unique<CMockShape>(Color::Black);
		CShape & refShape2 = *shape2;
		unique_ptr<CShape> shape3 = make_unique<CMockShape>(Color::Black);
